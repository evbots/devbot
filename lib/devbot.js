  ...
  webserver.get('/callback', function (req, res) {
    ...
    function saveToken(error, result) {
      ...
      controller.storage.users.get(slackUserId, function(err, userData) {
        if (userData == null) {
          controller.storage.users.save({id: slackUserId, github_access_token: parsedQueryString.access_token}, function(err) {
